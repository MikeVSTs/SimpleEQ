...
void SimpleEQAudioProcessor::updateFilters()
{
    ...
    /* DBG("High Slope: " + std::to_string(chainSettings.highCutSlope));
    ** DBG("High Freq: " + std::to_string(int(chainSettings.highCutFreq)));*/
    ...
    SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("HighCut Freq", "HighCut Freq", juce::NormalisableRange<float>(5000.f, 20000.f, 1.f, 0.25f), 18000.f));
